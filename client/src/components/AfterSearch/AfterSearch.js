    ...
    <section className={classes.afterSearchSection}>
      ...
      <div className={classes.productList}>
        <div className={filterClasses}>
          <Button onClick={activeFilterHandler} className={classes.row}>
            {filterMess}
          </Button>
          ...
          <div className={classes.row}>
            <div className={classes.column}>
              ...
              <input
                ...
                onChange={(e) =>
                  setFilter({ ...filter, shop_name: e.target.value })
                }
              />
            </div>
            <div className={classes.column}>
              <input
                ...
                onChange={(e) =>
                  setFilter({ ...filter, shop_address: e.target.value })
                }
              />
              <input
                type="number"
                placeholder="Shop Rate (Min)"
                onChange={(e) =>
                  setFilter({ ...filter, shop_rate: e.target.value })
                }
              />
            </div>
          </div>
          <div className={classes.row}>
            ...
            <input
              ...
              onChange={(e) =>
                setFilter({
                  ...filter,
                  price: { ...filter.price, min: e.target.value },
                })
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                setFilter({
                  ...filter,
                  price: { ...filter.price, max: e.target.value },
                })
              }
            />
          </div>
